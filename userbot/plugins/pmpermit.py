...
if PMPERMIT_PIC is None:
    WARN_PIC = "https://telegra.ph/file/f1a92643e091cb9bc39cc.jpg"
else:
...
CUSTOM_MIDDLE_PMP = (str(CUSTOM_PMPERMIT)
                     if CUSTOM_PMPERMIT else "Protection of Apka Bhai 🇮🇳")
USER_BOT_WARN_ZERO = "You Have Attempted To Spam My Masters Inbox So Inorder To Avoid Over Spam, You Have Been Blocked By Userbot"
